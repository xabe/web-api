...
class PersonResourceTest {
    ...
    public void givenAPersonPayloadWhenInvokeCreatePersonThenReturnResponseOk() throws Exception {
        //Given
        final UriInfo uriInfo = mock(UriInfo.class);
        final UriBuilder uriBuilder = new ResteasyUriBuilderImpl();
        ...
        assertThat(result.getLocation(), is(notNullValue()));
        assertThat(result.getLocation(), is(new ResteasyUriBuilderImpl().path("id").build()));
    }
    ...
    public void givenAPersonPayloadAndPersonIdWhenInvokePatchPersonThenReturnResponsePerson() throws Exception {
        //Given
        final UriInfo uriInfo = mock(UriInfo.class);
        final UriBuilder uriBuilder = new ResteasyUriBuilderImpl().path("id");
        ...
        assertThat(result.getLocation(), is(notNullValue()));
        assertThat(result.getLocation(), is(new ResteasyUriBuilderImpl().path(personId).build()));
    }
