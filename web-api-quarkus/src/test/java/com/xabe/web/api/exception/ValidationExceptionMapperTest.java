...
class ValidationExceptionMapperTest {
    ...
    public void givenAValidationExceptionWhenInvokeToResponseThenReturnResponse() throws Exception {
        ...
        assertThat(result.getStatus(), is(Response.Status.INTERNAL_SERVER_ERROR.getStatusCode()));
        assertThat(result.getHeaders().get(HttpHeaders.CONTENT_TYPE).get(0), is(MediaTypeExt.APPLICATION_PROBLEM_JSON));
